      ...
      productAndAdvantage: {
        ...
        whyWin: {
          ...
          items: [
            ...
            "Brainium (Dr. Roger Long) como consultor externo con fee mensual y revenue-share alineado a resultados.",
          ],
        },
      },
      nextSteps: [
      ...
      productAndAdvantage: {
        ...
        whyWin: {
          ...
          items: [
            ...
            "Brainium (Dr. Roger Long) as an external advisor with a monthly fee and revenue-share aligned to results.",
          ],
        },
      },
      nextSteps: [
